        ...
        extends DefaultGraphModel
{
            ...
            Serializable
    {
         ...
         */
        @Override public DefaultEdge createEdgeCell(EE jGraphTEdge)
        {
         ...
         */
        @Override public DefaultGraphCell createVertexCell(VV jGraphTVertex)
        {
            ...
            Serializable
    {
         ...
         * @param e
         */
        @Override public void graphChanged(GraphModelEvent e)
        {
